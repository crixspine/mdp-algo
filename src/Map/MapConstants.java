...
public class MapConstants {
    ...
    //Graphic Constants
    public static final Color SZ_COLOR = Color.BLUE;   //Start Zone Color
    public static final Color GZ_COLOR = Color.LIGHTSEAGREEN;  //Goal Zone Color
    public static final Color UE_COLOR = Color.GREY;   //Unexplored Color
    ...
    public static final Color CW_COLOR = Color.LIGHTGRAY;  //Cell Border Color
